...
import { getVaccinationCenterByPinCode } from '../Service/Service'
...
const Card2 = (props) => {
    ...
    useEffect(() => {
        async function fun() {
            const res1 = await getVaccinationCenterByPinCode(district, dateArray[0].date);
            const res2 = await getVaccinationCenterByPinCode(district, dateArray[1].date);
            const res3 = await getVaccinationCenterByPinCode(district, dateArray[2].date);
